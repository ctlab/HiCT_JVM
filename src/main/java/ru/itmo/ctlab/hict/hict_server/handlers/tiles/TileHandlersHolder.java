...
public class TileHandlersHolder extends HandlersHolder {
  ...
  public void addHandlersToRouter(final @NotNull Router router) {
    router.get("/get_raw_tile").handler(ctx -> {
      ...
      final WritableRaster raster = Raster.createInterleavedRaster(buffer, tileWidth, tileHeight, 3 * tileWidth, 3, new int[]{0, 1, 2}, (Point) null);
