...
* Windows SFX EXE: directory containing the EXE when the launcher can infer it from the parent process; otherwise the temporary extraction directory used by the official 7-Zip/LZMA SDK SFX module.
