...
The workflow can also be run manually and exposes toggles for bundled `hictk`, the default bundled Tauri browser, the optional bundled Electron browser, the `hictk` release tag, the HiCT_WebUI ref, and the optional Windows SFX EXE.
