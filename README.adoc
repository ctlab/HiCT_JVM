...
The Windows EXE is built only from official 7-Zip/LZMA SDK SFX modules (`7zS2con.sfx`, `7zS2.sfx`, `7zSD.sfx`, or `7zS.sfx`) and runs the same portable app without installation.
The build prefers the non-installer console SFX module (`7zS2con.sfx`) to avoid unnecessary UAC elevation prompts.
