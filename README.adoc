...
It embeds an official standalone 7-Zip/LZMA extractor plus the portable app payload, extracts into `%LOCALAPPDATA%\HiCT\portable\...`, and skips extraction on later launches when the content-addressed cache marker matches.
