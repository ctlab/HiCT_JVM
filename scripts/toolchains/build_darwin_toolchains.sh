...
build_minimap2() {
  ...
  [[ -f "${stage_dir}/share/licenses/minimap2/LICENSE.txt" && ! -f "${stage_dir}/share/licenses/minimap2/LICENSE" ]] && cp "${stage_dir}/share/licenses/minimap2/LICENSE.txt" "${stage_dir}/share/licenses/minimap2/LICENSE"
  [[ -f "${stage_dir}/share/licenses/minimap2/LICENSE" && ! -f "${stage_dir}/share/licenses/minimap2/LICENSE.txt" ]] && cp "${stage_dir}/share/licenses/minimap2/LICENSE" "${stage_dir}/share/licenses/minimap2/LICENSE.txt"
...
build_mm2plus() {
  ...
  [[ -f "${stage_dir}/share/licenses/mm2plus/LICENSE.txt" && ! -f "${stage_dir}/share/licenses/mm2plus/LICENSE" ]] && cp "${stage_dir}/share/licenses/mm2plus/LICENSE.txt" "${stage_dir}/share/licenses/mm2plus/LICENSE"
  [[ -f "${stage_dir}/share/licenses/mm2plus/LICENSE" && ! -f "${stage_dir}/share/licenses/mm2plus/LICENSE.txt" ]] && cp "${stage_dir}/share/licenses/mm2plus/LICENSE" "${stage_dir}/share/licenses/mm2plus/LICENSE.txt"
